...
questions = [
    {"id": 1, "topic": "CI/CD", "question": "Что делает GitHub Actions?", "options": ['Хостит код', 'Запускает авто-тесты и деплой при push/PR', 'Управляет пользователями', 'Отслеживает баги'], "correct": "Запускает авто-тесты и деплой при push/PR"},
    {"id": 2, "topic": "CI/CD", "question": "Как настроить Webhook для авто-деплоя?", "options": ['GitHub → Webhook → HTTP-запрос на сервер', 'Написать Dockerfile', 'Настроить firewall', 'Создать базу данных'], "correct": "GitHub → Webhook → HTTP-запрос на сервер"},
    {"id": 3, "topic": "CI/CD", "question": "Чем отличается Git от GitHub?", "options": ['Git — язык программирования', 'Git — локальная система контроля версий, GitHub — облачный хостинг', 'Git — база данных', 'GitHub — IDE'], "correct": "Git — локальная система контроля версий, GitHub — облачный хостинг"},
    {"id": 4, "topic": "CI/CD", "question": "Что такое CI/CD?", "options": ['Непрерывная интеграция и непрерывная доставка', 'Система контроля версий', 'Язык программирования', 'База данных'], "correct": "Непрерывная интеграция и непрерывная доставка"},
    {"id": 5, "topic": "CI/CD", "question": "Что делает команда 'git pull'?", "options": ['Отправляет изменения на сервер', 'Загружает изменения с сервера и сливает их', 'Создает новую ветку', 'Удаляет файлы'], "correct": "Загружает изменения с сервера и сливает их"},
    {"id": 6, "topic": "CI/CD", "question": "Что такое Pull Request?", "options": ['Запрос на вливание кода в основную ветку', 'Команда git', 'Тип ошибки', 'Система мониторинга'], "correct": "Запрос на вливание кода в основную ветку"},
    {"id": 7, "topic": "CI/CD", "question": "Как откатить последний коммит в Git?", "options": ['git reset --hard HEAD~1', 'git delete commit', 'git remove', 'git undo'], "correct": "git reset --hard HEAD~1"},
    {"id": 8, "topic": "CI/CD", "question": "Что такое Jenkins?", "options": ['CI/CD сервер', 'База данных', 'Файрвол', 'IDE'], "correct": "CI/CD сервер"},
    {"id": 9, "topic": "CI/CD", "question": "Чем отличается git merge от git rebase?", "options": ['Merge создает коммит слияния, rebase переписывает историю', 'Rebase создает коммит слияния, merge переписывает историю', 'Они одинаковые', 'Ни один'], "correct": "Merge создает коммит слияния, rebase переписывает историю"},
    {"id": 10, "topic": "CI/CD", "question": "Что такое Git Flow?", "options": ['Модель ветвления', 'Команда git', 'Система мониторинга', 'База данных'], "correct": "Модель ветвления"},
    {"id": 11, "topic": "CI/CD", "question": "Как создать новую ветку в Git?", "options": ['git branch new-branch', 'git checkout -b new-branch', 'Оба варианта', 'Ни один'], "correct": "Оба варианта"},
    {"id": 12, "topic": "CI/CD", "question": "Что делает 'git stash'?", "options": ['Удаляет изменения', 'Временно сохраняет изменения', 'Коммитит изменения', 'Переключает ветку'], "correct": "Временно сохраняет изменения"},
    {"id": 13, "topic": "CI/CD", "question": "Что такое GitLab CI?", "options": ['Встроенная CI/CD система в GitLab', 'Язык программирования', 'База данных', 'IDE'], "correct": "Встроенная CI/CD система в GitLab"},
    {"id": 14, "topic": "CI/CD", "question": "Как посмотреть историю коммитов?", "options": ['git log', 'git history', 'git show', 'git diff'], "correct": "git log"},
    {"id": 15, "topic": "CI/CD", "question": "Что такое 'git cherry-pick'?", "options": ['Применяет указанный коммит в текущую ветку', 'Удаляет коммит', 'Создает новую ветку', 'Объединяет ветки'], "correct": "Применяет указанный коммит в текущую ветку"},
    {"id": 16, "topic": "CI/CD", "question": "Как разрешить конфликт в Git?", "options": ['Вручную отредактировать файлы, затем add + commit', 'git merge --abort', 'git rebase --skip', 'Все варианты'], "correct": "Вручную отредактировать файлы, затем add + commit"},
    {"id": 17, "topic": "CI/CD", "question": "Что такое Git Hooks?", "options": ['Скрипты, запускаемые при определенных событиях', 'Система мониторинга', 'База данных', 'IDE'], "correct": "Скрипты, запускаемые при определенных событиях"},
    {"id": 18, "topic": "CI/CD", "question": "Что делает 'git push --force'?", "options": ['Принудительно отправляет изменения, перезаписывая историю', 'Отправляет изменения без проверки', 'Удаляет удаленный репозиторий', 'Ничего не делает'], "correct": "Принудительно отправляет изменения, перезаписывая историю"},
    {"id": 19, "topic": "CI/CD", "question": "Что такое artifacts в CI/CD?", "options": ['Результаты сборки (файлы, логи, бинарники)', 'Система контроля версий', 'Сетевой протокол', 'Тип сервера'], "correct": "Результаты сборки (файлы, логи, бинарники)"},
    {"id": 20, "topic": "CI/CD", "question": "Что такое pipeline?", "options": ['Последовательность шагов CI/CD', 'База данных', 'Тип сервера', 'Язык программирования'], "correct": "Последовательность шагов CI/CD"},
    {"id": 21, "topic": "CI/CD", "question": "Что такое 'rollback' в CI/CD?", "options": ['Откат к предыдущей версии', 'Новый деплой', 'Запуск тестов', 'Сборка проекта'], "correct": "Откат к предыдущей версии"},
    {"id": 22, "topic": "CI/CD", "question": "Что такое 'cache' в GitHub Actions?", "options": ['Кеширование зависимостей между запусками', 'Хранение логов', 'Тип экшена', 'Система мониторинга'], "correct": "Кеширование зависимостей между запусками"},
    {"id": 23, "topic": "CI/CD", "question": "Что такое ределивер в контексте GitHub Webhook?", "options": ['Повторная отправка неудачных доставок', 'Отмена доставки', 'Проверка статуса', 'Логирование'], "correct": "Повторная отправка неудачных доставок"},
    {"id": 24, "topic": "CI/CD", "question": "Какой инструмент используется в ределивере для работы с GitHub API?", "options": ['axios', 'request', 'Octokit', 'fetch'], "correct": "Octokit"},
    {"id": 25, "topic": "CI/CD", "question": "Что такое GitHub Actions runner?", "options": ['Агент, который выполняет jobs', 'Сервер баз данных', 'Система мониторинга', 'Веб-сервер'], "correct": "Агент, который выполняет jobs"},
    {"id": 26, "topic": "CI/CD", "question": "Что такое self-hosted runner?", "options": ['Собственный сервер для GitHub Actions', 'Облачный runner', 'Виртуальная машина', 'Docker контейнер'], "correct": "Собственный сервер для GitHub Actions"},
    {"id": 27, "topic": "Databases", "question": "Что такое SQL?", "options": ['Язык запросов к базам данных', 'База данных', 'Сервер БД', 'CI/CD система'], "correct": "Язык запросов к базам данных"},
    {"id": 28, "topic": "Databases", "question": "Чем отличается PostgreSQL от MySQL?", "options": ['PostgreSQL — объектно-реляционная, MySQL — реляционная', 'Они одинаковые', 'PostgreSQL быстрее', 'MySQL — ORM'], "correct": "PostgreSQL — объектно-реляционная, MySQL — реляционная"},
    {"id": 29, "topic": "Databases", "question": "Что такое JOIN?", "options": ['Объединение таблиц', 'Создание индекса', 'Удаление данных', 'Создание БД'], "correct": "Объединение таблиц"},
    {"id": 30, "topic": "Databases", "question": "Как сделать резервное копирование PostgreSQL?", "options": ['pg_dump dbname > backup.sql', 'psql dump', 'backup postgres', 'pg_backup'], "correct": "pg_dump dbname > backup.sql"},
    {"id": 31, "topic": "Databases", "question": "Что такое индекс в БД?", "options": ['Ускоряет поиск данных', 'Тип данных', 'Система логирования', 'CI/CD система'], "correct": "Ускоряет поиск данных"},
    {"id": 32, "topic": "Docker", "question": "Что такое Docker?", "options": ['Виртуальная машина', 'Система контейнеризации', 'Язык программирования', 'База данных'], "correct": "Система контейнеризации"},
    {"id": 33, "topic": "Docker", "question": "Чем отличается контейнер от виртуальной машины?", "options": ['Контейнер легче и использует ядро хоста', 'Контейнер тяжелее', 'Это одно и то же', 'ВМ легче'], "correct": "Контейнер легче и использует ядро хоста"},
    {"id": 34, "topic": "Docker", "question": "Какая команда собирает Docker образ?", "options": ['docker build', 'docker create', 'docker run', 'docker start'], "correct": "docker build"},
    {"id": 35, "topic": "Docker", "question": "Что делает 'docker-compose up -d'?", "options": ['Останавливает все контейнеры', 'Запускает все контейнеры из docker-compose.yml в фоне', 'Удаляет контейнеры', 'Собирает образы'], "correct": "Запускает все контейнеры из docker-compose.yml в фоне"},
    {"id": 36, "topic": "Docker", "question": "Как посмотреть запущенные контейнеры?", "options": ['docker ps', 'docker list', 'docker show', 'docker containers'], "correct": "docker ps"},
    {"id": 37, "topic": "Docker", "question": "Как остановить контейнер?", "options": ['docker stop <id>', 'docker kill <id>', 'docker rm <id>', 'docker pause <id>'], "correct": "docker stop <id>"},
    {"id": 38, "topic": "Docker", "question": "Что такое Docker Compose?", "options": ['Инструмент для многоконтейнерных приложений', 'Язык разметки', 'База данных', 'Веб-сервер'], "correct": "Инструмент для многоконтейнерных приложений"},
    {"id": 39, "topic": "Docker", "question": "Что такое Dockerfile?", "options": ['Файл с инструкциями для сборки образа', 'Файл с конфигурацией сети', 'Файл с логами', 'Файл с данными'], "correct": "Файл с инструкциями для сборки образа"},
    {"id": 40, "topic": "Docker", "question": "Как удалить все неиспользуемые образы и контейнеры?", "options": ['docker system prune -a', 'docker rm -a', 'docker rmi -a', 'docker clean all'], "correct": "docker system prune -a"},
    {"id": 41, "topic": "Docker", "question": "Что такое volume в Docker?", "options": ['Механизм сохранения данных вне контейнера', 'Тип сети', 'Контейнер с БД', 'Образ Docker'], "correct": "Механизм сохранения данных вне контейнера"},
    {"id": 42, "topic": "Docker", "question": "Как посмотреть логи контейнера?", "options": ['docker logs <id>', 'docker logs -f <id>', 'Оба варианта', 'Ни один'], "correct": "Оба варианта"},
    {"id": 43, "topic": "Docker", "question": "Что такое Docker Hub?", "options": ['Регистр хранения Docker образов', 'Инструмент оркестрации', 'Система мониторинга', 'Тип сети'], "correct": "Регистр хранения Docker образов"},
    {"id": 44, "topic": "Docker", "question": "Что делает 'docker exec'?", "options": ['Запускает команду внутри работающего контейнера', 'Удаляет контейнер', 'Останавливает контейнер', 'Создает образ'], "correct": "Запускает команду внутри работающего контейнера"},
    {"id": 45, "topic": "Docker", "question": "Как ограничить ресурсы контейнера?", "options": ['--memory=512m --cpus=0.5', '--limit-mem=512', '--res=512', 'Нельзя'], "correct": "--memory=512m --cpus=0.5"},
    {"id": 46, "topic": "Docker", "question": "Что такое Docker Swarm?", "options": ['Инструмент оркестрации контейнеров', 'База данных', 'Веб-сервер', 'Язык программирования'], "correct": "Инструмент оркестрации контейнеров"},
    {"id": 47, "topic": "Docker", "question": "Что такое 'multi-stage build' в Docker?", "options": ['Многоэтапная сборка для уменьшения образа', 'Тип контейнера', 'Сеть Docker', 'Система мониторинга'], "correct": "Многоэтапная сборка для уменьшения образа"},
    {"id": 48, "topic": "Docker", "question": "Что делает 'docker push'?", "options": ['Отправляет образ в реестр', 'Загружает образ', 'Удаляет образ', 'Создает контейнер'], "correct": "Отправляет образ в реестр"},
    {"id": 49, "topic": "Docker", "question": "Что такое Dockerfile?", "options": ['Файл с инструкциями для сборки образа', 'Файл с конфигурацией сети', 'Файл с логами', 'Файл с данными'], "correct": "Файл с инструкциями для сборки образа"},
    {"id": 50, "topic": "Docker", "question": "Какая команда собирает Docker образ из Dockerfile?", "options": ['docker create', 'docker build', 'docker run', 'docker start'], "correct": "docker build"},
    {"id": 51, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Что такое Forgejo?", "options": ['Платформа для хостинга Git-репозиториев (аналог GitHub)', 'CI/CD сервер', 'База данных', 'Веб-сервер'], "correct": "Платформа для хостинга Git-репозиториев (аналог GitHub)"},
    {"id": 52, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой CI/CD сервер используется в связке с Forgejo в вашем проекте?", "options": ['Jenkins', 'Drone CI', 'GitLab CI', 'GitHub Actions'], "correct": "Drone CI"},
    {"id": 53, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой протокол использует Forgejo для уведомления Drone о новых коммитах?", "options": ['SSH', 'Webhook', 'FTP', 'SMTP'], "correct": "Webhook"},
    {"id": 54, "topic": "Drone CI + Codeberg (Forgejo)", "question": "На каком порту работает Drone Server в настроенной конфигурации?", "options": ['80', '443', '8000', '8080'], "correct": "8000"},
    {"id": 55, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какая переменная окружения используется для связи Drone Server и Drone Runner?", "options": ['DRONE_RPC_SECRET', 'DRONE_TOKEN', 'DRONE_KEY', 'DRONE_PASSWORD'], "correct": "DRONE_RPC_SECRET"},
    {"id": 56, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Что делает Drone Runner?", "options": ['Запускает пайплайны', 'Хранит код', 'Отправляет уведомления', 'Управляет пользователями'], "correct": "Запускает пайплайны"},
    {"id": 57, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой файл конфигурации используется в Drone CI?", "options": ['.drone.yml', '.woodpecker.yml', '.github/workflows', '.gitlab-ci.yml'], "correct": ".drone.yml"},
    {"id": 58, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой образ Docker используется для выполнения SSH-команд в пайплайне?", "options": ['alpine', 'ubuntu', 'appleboy/drone-ssh', 'curlimages/curl'], "correct": "appleboy/drone-ssh"},
    {"id": 59, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой образ используется для отправки уведомлений в Telegram в пайплайне?", "options": ['appleboy/drone-telegram', 'curlimages/curl', 'alpine', 'ubuntu'], "correct": "curlimages/curl"},
    {"id": 60, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой секрет необходимо добавить в Drone для доступа к серверу по SSH?", "options": ['ssh_key', 'deploy_key', 'server_key', 'private_key'], "correct": "ssh_key"},
    {"id": 61, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой секрет необходимо добавить в Drone для отправки сообщений в Telegram?", "options": ['telegram_token', 'bot_token', 'tg_token', 'api_key'], "correct": "telegram_token"},
    {"id": 62, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой командой запускается Drone Server в Docker?", "options": ['docker run -d --name drone-server -p 8000:80 ...', 'docker start drone-server', 'systemctl start drone', 'drone server start'], "correct": "docker run -d --name drone-server -p 8000:80 ..."},
    {"id": 63, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой командой перезапускается systemd-сервис post-generator в пайплайне?", "options": ['systemctl restart post-generator', 'service post-generator restart', 'restart post-generator', 'docker restart post-generator'], "correct": "systemctl restart post-generator"},
    {"id": 64, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Как проверить, что вебхук Forgejo работает?", "options": ['curl -X POST http://localhost:8000/hook', 'ping codeberg.org', 'ssh forgejo', 'docker logs drone'], "correct": "curl -X POST http://localhost:8000/hook"},
    {"id": 65, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Что делать, если вебхук Drone не отвечает (код 405)?", "options": ['Перезапустить Drone Server', 'Поменять порт', 'Обновить конфиг', 'Переустановить Forgejo'], "correct": "Перезапустить Drone Server"},
    {"id": 66, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Как настроить автоматическое восстановление Drone при падении?", "options": ['Cron + webhook_monitor.sh', 'Systemd сервис', 'Docker restart policy', 'Вручную'], "correct": "Cron + webhook_monitor.sh"},
    {"id": 67, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой скрипт проверяет доступность вебхука каждые 5 минут?", "options": ['webhook_monitor.sh', 'healthcheck.sh', 'drone_check.sh', 'monitor.sh'], "correct": "webhook_monitor.sh"},
    {"id": 68, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой командой отправляется тестовый вебхук в Drone?", "options": ['curl -X POST http://localhost:8000/hook -d \'{"ref":"refs/heads/master"}\'', 'drone webhook send', 'webhook test', 'curl http://localhost:8000/hook'], "correct": "curl -X POST http://localhost:8000/hook -d '{\"ref\":\"refs/heads/master\"}'"},
    {"id": 69, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой домен используется для AI Post Generator?", "options": ['aigenerator.myvnc.com', 'ai.cuby.by', 'generator.ai', 'post.ai'], "correct": "aigenerator.myvnc.com"},
    {"id": 70, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Как называется Telegram-бот для уведомлений о деплое?", "options": ['@SeRveDog_bot', '@AIPostBot', '@DeployBot', '@DroneBot'], "correct": "@SeRveDog_bot"},
    {"id": 71, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой порт слушает Streamlit-приложение post-generator?", "options": ['8501', '8502', '8080', '8000'], "correct": "8502"},
    {"id": 72, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой параметр systemd ограничивает использование CPU?", "options": ['CPUQuota', 'MemoryMax', 'LimitCPU', 'CPUMax'], "correct": "CPUQuota"},
    {"id": 73, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой параметр systemd ограничивает использование памяти?", "options": ['MemoryMax', 'CPUQuota', 'LimitMemory', 'MemMax'], "correct": "MemoryMax"},
    {"id": 74, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Как часто cron запускает webhook_monitor.sh?", "options": ['Каждые 5 минут', 'Каждую минуту', 'Каждый час', 'Раз в день'], "correct": "Каждые 5 минут"},
    {"id": 75, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Что происходит при успешном деплое в Telegram?", "options": ['Приходит уведомление с галочкой', 'Ничего', 'Приходит ошибка', 'Перезапускается сервер'], "correct": "Приходит уведомление с галочкой"},
    {"id": 76, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какая команда перезапускает Drone Server в скрипте мониторинга?", "options": ['docker restart drone-server', 'systemctl restart drone', 'reboot', 'killall drone'], "correct": "docker restart drone-server"},
    {"id": 77, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой метод HTTP используется для вебхука Forgejo?", "options": ['POST', 'GET', 'PUT', 'DELETE'], "correct": "POST"},
    {"id": 78, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой URL используется для вебхука в Forgejo?", "options": ['http://103.125.216.110:8000/hook', 'http://localhost:8000/webhook', 'https://codeberg.org/hook', 'http://drone:8000/hook'], "correct": "http://103.125.216.110:8000/hook"},
    {"id": 79, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какая ветка триггерит деплой?", "options": ['master', 'main', 'develop', 'feature/*'], "correct": "master"},
    {"id": 80, "topic": "Drone CI + Codeberg (Forgejo)", "question": "Какой шаг в .drone.yml отвечает за деплой?", "options": ['deploy', 'build', 'test', 'notify'], "correct": "deploy"},
    {"id": 81, "topic": "Forgejo CI/CD", "question": "Что такое Forgejo?", "options": ['Платформа для хостинга Git-репозиториев (аналог GitHub)', 'CI/CD сервер', 'База данных', 'Веб-сервер'], "correct": "Платформа для хостинга Git-репозиториев (аналог GitHub)"},
    {"id": 82, "topic": "Forgejo CI/CD", "question": "Какой сервис используется в качестве CI/CD в связке с Forgejo?", "options": ['Jenkins', 'GitLab CI', 'Drone CI', 'GitHub Actions'], "correct": "Drone CI"},
    {"id": 83, "topic": "Forgejo CI/CD", "question": "Какой протокол использует Forgejo для уведомления Drone о новых коммитах?", "options": ['SSH', 'Webhook', 'FTP', 'SMTP'], "correct": "Webhook"},
    {"id": 84, "topic": "Forgejo CI/CD", "question": "На каком порту работает Drone Server в настроенной конфигурации?", "options": ['80', '443', '8000', '8080'], "correct": "8000"},
    {"id": 85, "topic": "Forgejo CI/CD", "question": "Какая переменная окружения используется для связи Drone Server и Drone Runner?", "options": ['DRONE_RPC_SECRET', 'DRONE_TOKEN', 'DRONE_KEY', 'DRONE_PASSWORD'], "correct": "DRONE_RPC_SECRET"},
    {"id": 86, "topic": "Forgejo CI/CD", "question": "Что делает Drone Runner?", "options": ['Запускает пайплайны', 'Хранит код', 'Отправляет уведомления', 'Управляет пользователями'], "correct": "Запускает пайплайны"},
    {"id": 87, "topic": "Forgejo CI/CD", "question": "Какой файл конфигурации используется в Drone CI?", "options": ['.drone.yml', '.woodpecker.yml', '.github/workflows', '.gitlab-ci.yml'], "correct": ".drone.yml"},
    {"id": 88, "topic": "Forgejo CI/CD", "question": "Какой образ Docker используется для выполнения SSH-команд в пайплайне?", "options": ['alpine', 'ubuntu', 'appleboy/drone-ssh', 'curlimages/curl'], "correct": "appleboy/drone-ssh"},
    {"id": 89, "topic": "Forgejo CI/CD", "question": "Какой образ используется для отправки Telegram-уведомлений в пайплайне?", "options": ['appleboy/drone-telegram', 'curlimages/curl', 'alpine', 'ubuntu'], "correct": "curlimages/curl"},
    {"id": 90, "topic": "Forgejo CI/CD", "question": "Какой секрет необходимо добавить в Drone для доступа к серверу по SSH?", "options": ['ssh_key', 'deploy_key', 'server_key', 'private_key'], "correct": "ssh_key"},
    {"id": 91, "topic": "Forgejo CI/CD", "question": "Какой секрет необходимо добавить в Drone для отправки сообщений в Telegram?", "options": ['telegram_token', 'bot_token', 'tg_token', 'api_key'], "correct": "telegram_token"},
    {"id": 92, "topic": "Forgejo CI/CD", "question": "Какой командой запускается Drone Server в Docker?", "options": ['docker run -d --name drone-server -p 8000:80 ...', 'docker start drone-server', 'systemctl start drone', 'drone server start'], "correct": "docker run -d --name drone-server -p 8000:80 ..."},
    {"id": 93, "topic": "Forgejo CI/CD", "question": "Какой командой перезапускается systemd сервис post-generator в пайплайне?", "options": ['systemctl restart post-generator', 'service post-generator restart', 'restart post-generator', 'docker restart post-generator'], "correct": "systemctl restart post-generator"},
    {"id": 94, "topic": "Forgejo CI/CD", "question": "Как проверить, что вебхук Forgejo работает?", "options": ['curl -X POST http://localhost:8000/hook', 'ping codeberg.org', 'ssh forgejo', 'docker logs drone'], "correct": "curl -X POST http://localhost:8000/hook"},
    {"id": 95, "topic": "Forgejo CI/CD", "question": "Что делать, если вебхук Drone не отвечает (код 405)?", "options": ['Перезапустить Drone Server', 'Поменять порт', 'Обновить конфиг', 'Переустановить Forgejo'], "correct": "Перезапустить Drone Server"},
    {"id": 96, "topic": "Forgejo CI/CD", "question": "Как настроить автоматическое восстановление Drone при падении?", "options": ['Cron + webhook_monitor.sh', 'Systemd сервис', 'Docker restart policy', 'Вручную'], "correct": "Cron + webhook_monitor.sh"},
    {"id": 97, "topic": "Forgejo CI/CD", "question": "Какой скрипт проверяет доступность вебхука каждые 5 минут?", "options": ['webhook_monitor.sh', 'healthcheck.sh', 'drone_check.sh', 'monitor.sh'], "correct": "webhook_monitor.sh"},
    {"id": 98, "topic": "Forgejo CI/CD", "question": "Какой домен используется для AI Post Generator?", "options": ['aigenerator.myvnc.com', 'ai.cuby.by', 'generator.ai', 'post.ai'], "correct": "aigenerator.myvnc.com"},
    {"id": 99, "topic": "Forgejo CI/CD", "question": "Как называется Telegram-бот для уведомлений о деплое?", "options": ['@SeRveDog_bot', '@AIPostBot', '@DeployBot', '@DroneBot'], "correct": "@SeRveDog_bot"},
    {"id": 100, "topic": "Forgejo CI/CD", "question": "Какой порт слушает Streamlit-приложение post-generator?", "options": ['8501', '8502', '8080', '8000'], "correct": "8502"},
    {"id": 101, "topic": "Forgejo CI/CD", "question": "Какой параметр systemd ограничивает использование CPU?", "options": ['CPUQuota', 'MemoryMax', 'LimitCPU', 'CPUMax'], "correct": "CPUQuota"},
    {"id": 102, "topic": "Forgejo CI/CD", "question": "Какой параметр systemd ограничивает использование памяти?", "options": ['MemoryMax', 'CPUQuota', 'LimitMemory', 'MemMax'], "correct": "MemoryMax"},
    {"id": 103, "topic": "Forgejo CI/CD", "question": "Как часто cron запускает webhook_monitor.sh?", "options": ['Каждые 5 минут', 'Каждую минуту', 'Каждый час', 'Раз в день'], "correct": "Каждые 5 минут"},
    {"id": 104, "topic": "Forgejo CI/CD", "question": "Что происходит при успешном деплое в Telegram?", "options": ['Приходит уведомление с галочкой', 'Ничего', 'Приходит ошибка', 'Перезапускается сервер'], "correct": "Приходит уведомление с галочкой"},
    {"id": 105, "topic": "Forgejo CI/CD", "question": "Какая команда перезапускает Drone Server в скрипте мониторинга?", "options": ['docker restart drone-server', 'systemctl restart drone', 'reboot', 'killall drone'], "correct": "docker restart drone-server"},
    {"id": 106, "topic": "Forgejo CI/CD", "question": "Какой метод HTTP используется для вебхука Forgejo?", "options": ['POST', 'GET', 'PUT', 'DELETE'], "correct": "POST"},
    {"id": 107, "topic": "Forgejo CI/CD", "question": "Какой URL используется для вебхука в Forgejo?", "options": ['http://103.125.216.110:8000/hook', 'http://localhost:8000/webhook', 'https://codeberg.org/hook', 'http://drone:8000/hook'], "correct": "http://103.125.216.110:8000/hook"},
    {"id": 108, "topic": "Forgejo CI/CD", "question": "Какая ветка триггерит деплой?", "options": ['master', 'main', 'develop', 'feature/*'], "correct": "master"},
    {"id": 109, "topic": "Forgejo CI/CD", "question": "Какой шаг в .drone.yml отвечает за деплой?", "options": ['deploy', 'build', 'test', 'notify'], "correct": "deploy"},
    {"id": 110, "topic": "Forgejo CI/CD", "question": "Что такое Forgejo?", "options": ['Платформа для хостинга Git', 'CI/CD сервер', 'База данных', 'Веб-сервер'], "correct": "Платформа для хостинга Git"},
    {"id": 111, "topic": "Forgejo CI/CD", "question": "Какой CI/CD сервер используется с Forgejo?", "options": ['Jenkins', 'Drone CI', 'GitLab CI', 'GitHub Actions'], "correct": "Drone CI"},
    {"id": 112, "topic": "Forgejo CI/CD", "question": "Какой протокол использует Forgejo для уведомления Drone?", "options": ['SSH', 'Webhook', 'FTP', 'SMTP'], "correct": "Webhook"},
    {"id": 113, "topic": "Git", "question": "Какая команда отменяет последний коммит, сохраняя изменения в рабочей директории?", "options": ['git reset --soft HEAD~1', 'git reset --hard HEAD~1', 'git revert HEAD', 'git checkout HEAD~1'], "correct": "git reset --soft HEAD~1"},
    {"id": 114, "topic": "Git", "question": "Что делает команда 'git revert'?", "options": ['Удаляет коммит из истории', 'Создаёт новый коммит, отменяющий изменения', 'Перемещает указатель ветки', 'Очищает рабочую директорию'], "correct": "Создаёт новый коммит, отменяющий изменения"},
    {"id": 115, "topic": "Kubernetes", "question": "Что такое Kubernetes?", "options": ['Оркестратор контейнеров', 'База данных', 'Язык программирования', 'CI/CD система'], "correct": "Оркестратор контейнеров"},
    {"id": 116, "topic": "Kubernetes", "question": "Что такое Pod в Kubernetes?", "options": ['Группа контейнеров', 'Физический сервер', 'Сеть', 'База данных'], "correct": "Группа контейнеров"},
    {"id": 117, "topic": "Kubernetes", "question": "Что делает kubectl?", "options": ['CLI для управления K8s', 'Сервер баз данных', 'Система мониторинга', 'Веб-сервер'], "correct": "CLI для управления K8s"},
    {"id": 118, "topic": "Kubernetes", "question": "Что такое Deployment?", "options": ['Ресурс для управления подами', 'База данных', 'Тип сети', 'Система мониторинга'], "correct": "Ресурс для управления подами"},
    {"id": 119, "topic": "Kubernetes", "question": "Что такое Service в K8s?", "options": ['Балансирует трафик к подам', 'База данных', 'Сеть', 'Тип пода'], "correct": "Балансирует трафик к подам"},
    {"id": 120, "topic": "Kubernetes", "question": "Что такое Ingress?", "options": ['Управляет внешним доступом к сервисам', 'Тип пода', 'База данных', 'Система мониторинга'], "correct": "Управляет внешним доступом к сервисам"},
    {"id": 121, "topic": "Kubernetes", "question": "Что такое ConfigMap?", "options": ['Хранит конфигурацию', 'База данных', 'Тип сети', 'Система мониторинга'], "correct": "Хранит конфигурацию"},
    {"id": 122, "topic": "Kubernetes", "question": "Что такое 'kubelet'?", "options": ['Агент на узле, управляющий подам', 'CLI для K8s', 'База данных', 'Система мониторинга'], "correct": "Агент на узле, управляющий подам"},
    {"id": 123, "topic": "Kubernetes", "question": "Что такое 'etcd'?", "options": ['Хранилище данных кластера K8s', 'База данных', 'Система логирования', 'Тип пода'], "correct": "Хранилище данных кластера K8s"},
    {"id": 124, "topic": "Kubernetes", "question": "Что такое readinessProbe в Kubernetes?", "options": ['Проверяет, готов ли под принимать трафик', 'Проверяет, жив ли контейнер', 'Проверяет диск', 'Проверяет сеть'], "correct": "Проверяет, готов ли под принимать трафик"},
    {"id": 125, "topic": "Kubernetes", "question": "Что такое livenessProbe в Kubernetes?", "options": ['Проверяет, жив ли контейнер, и перезапускает его при падении', 'Проверяет готовность к трафику', 'Проверяет диск', 'Проверяет сеть'], "correct": "Проверяет, жив ли контейнер, и перезапускает его при падении"},
    {"id": 126, "topic": "Linux", "question": "Как посмотреть логи systemd-сервиса в реальном времени?", "options": ['systemctl logs -f', 'journalctl -u <service> -f', 'tail -f /var/log/syslog', 'dmesg -w'], "correct": "journalctl -u <service> -f"},
    {"id": 127, "topic": "Linux", "question": "Как ограничить CPU для systemd-сервиса?", "options": ['CPULimit=80', 'CPUQuota=80%', 'LimitCPU=80', 'CPU=80%'], "correct": "CPUQuota=80%"},
    {"id": 128, "topic": "Linux", "question": "Как перезагрузить конфигурацию systemd после изменения файла?", "options": ['systemctl restart', 'systemctl reload', 'systemctl daemon-reload', 'systemctl update'], "correct": "systemctl daemon-reload"},
    {"id": 129, "topic": "Linux", "question": "Как посмотреть список всех активных сервисов systemd?", "options": ['systemctl list', 'systemctl status', 'systemctl list-units --type=service', 'systemctl show'], "correct": "systemctl list-units --type=service"},
    {"id": 130, "topic": "Linux", "question": "Какая команда показывает использование диска в человеко-читаемом формате?", "options": ['du -h', 'df -h', 'ls -lh', 'fdisk -l'], "correct": "df -h"},
    {"id": 131, "topic": "Linux", "question": "Как посмотреть, какие порты слушает сервер?", "options": ['netstat -tlnp', 'iptables -L', 'ss -s', 'tcpdump'], "correct": "netstat -tlnp"},
    {"id": 132, "topic": "Linux", "question": "Как найти процесс, который ест 100% CPU?", "options": ['htop (нажать P)', 'ls -l', 'ps aux', 'kill -9'], "correct": "htop (нажать P)"},
    {"id": 133, "topic": "Linux", "question": "Что делает команда 'chmod +x script.sh'?", "options": ['Удаляет файл', 'Делает файл исполняемым', 'Копирует файл', 'Переименовывает файл'], "correct": "Делает файл исполняемым"},
    {"id": 134, "topic": "Linux", "question": "Как посмотреть размер папки?", "options": ['ls -la', 'du -sh', 'df -h', 'find . -size'], "correct": "du -sh"},
    {"id": 135, "topic": "Linux", "question": "Как посмотреть историю команд в Bash?", "options": ['history', 'cat ~/.bash_history', 'Оба варианта', 'Ни один'], "correct": "Оба варианта"},
    {"id": 136, "topic": "Linux", "question": "Что такое inode?", "options": ['Структура с метаданными файла', 'IP адрес', 'Сетевое соединение', 'Тип файловой системы'], "correct": "Структура с метаданными файла"},
    {"id": 137, "topic": "Linux", "question": "Как применить права 755 к папке рекурсивно?", "options": ['chmod 755 *', 'chmod -R 755 ./', 'chmod 755 -R', 'chmod 755'], "correct": "chmod -R 755 ./"},
    {"id": 138, "topic": "Linux", "question": "Что такое cron?", "options": ['Сервис для мониторинга', 'Планировщик задач', 'Система логирования', 'База данных'], "correct": "Планировщик задач"},
    {"id": 139, "topic": "Linux", "question": "Как посмотреть последние 10 строк лога?", "options": ['head -10 file', 'tail -10 file', 'less file', 'grep -10 file'], "correct": "tail -10 file"},
    {"id": 140, "topic": "Linux", "question": "Что такое swap?", "options": ['Место на диске для расширения RAM', 'Тип процессора', 'Сетевое соединение', 'Системный вызов'], "correct": "Место на диске для расширения RAM"},
    {"id": 141, "topic": "Linux", "question": "Как убить процесс по имени?", "options": ['kill <pid>', 'pkill <name>', 'killall <name>', 'Оба варианта pkill и killall'], "correct": "Оба варианта pkill и killall"},
    {"id": 142, "topic": "Linux", "question": "Что делает команда 'grep -r pattern /path'?", "options": ['Ищет файлы по имени', 'Ищет паттерн в файлах рекурсивно', 'Удаляет файлы с паттерном', 'Заменяет паттерн'], "correct": "Ищет паттерн в файлах рекурсивно"},
    {"id": 143, "topic": "Linux", "question": "Как посмотреть загрузку CPU в реальном времени?", "options": ['top', 'htop', 'ps aux', 'Все варианты'], "correct": "Все варианты"},
    {"id": 144, "topic": "Linux", "question": "Что такое SSH?", "options": ['Протокол удалённого доступа', 'Сетевой файрвол', 'Система логирования', 'База данных'], "correct": "Протокол удалённого доступа"},
    {"id": 145, "topic": "Linux", "question": "Как создать systemd-сервис?", "options": ['Создать файл в /etc/systemd/system/*.service', 'Запустить systemd-create', 'Использовать init.d', 'Все варианты'], "correct": "Создать файл в /etc/systemd/system/*.service"},
    {"id": 146, "topic": "Linux", "question": "Что делает команда 'ps aux'?", "options": ['Показывает все процессы', 'Удаляет процессы', 'Создает процессы', 'Останавливает процессы'], "correct": "Показывает все процессы"},
    {"id": 147, "topic": "Linux", "question": "Как посмотреть версию ядра Linux?", "options": ['uname -r', 'kernel --version', 'version', 'cat /proc/version'], "correct": "uname -r"},
    {"id": 148, "topic": "Linux", "question": "Как посмотреть загрузку памяти?", "options": ['free -h', 'top', 'htop', 'Все варианты'], "correct": "Все варианты"},
    {"id": 149, "topic": "Linux", "question": "Что делает команда 'systemctl daemon-reload'?", "options": ['Перезагружает systemd', 'Перечитывает конфигурацию systemd', 'Перезапускает все сервисы', 'Останавливает systemd'], "correct": "Перечитывает конфигурацию systemd"},
    {"id": 150, "topic": "Linux", "question": "Какой лимит CPU установлен для Container Packer в systemd?", "options": ['50%', '80%', '100%', '200%'], "correct": "80%"},
    {"id": 151, "topic": "Linux", "question": "Какой лимит памяти установлен для Container Packer в systemd?", "options": ['256MB', '512MB', '800MB', '1GB'], "correct": "800MB"},
    {"id": 152, "topic": "Monitoring", "question": "Что такое Prometheus?", "options": ['Система мониторинга и метрик', 'База данных', 'Веб-сервер', 'CI/CD система'], "correct": "Система мониторинга и метрик"},
    {"id": 153, "topic": "Monitoring", "question": "Что такое Grafana?", "options": ['Инструмент визуализации дашбордов', 'Система логирования', 'База данных', 'CI/CD система'], "correct": "Инструмент визуализации дашбордов"},
    {"id": 154, "topic": "Monitoring", "question": "Что такое экспортёр в Prometheus?", "options": ['Сборщик метрик со сторонних систем', 'Дашборд', 'База данных', 'CI/CD система'], "correct": "Сборщик метрик со сторонних систем"},
    {"id": 155, "topic": "Monitoring", "question": "Что такое SLO?", "options": ['Service Level Objective — целевой уровень обслуживания', 'Система логирования', 'База данных', 'Тип метрики'], "correct": "Service Level Objective — целевой уровень обслуживания"},
    {"id": 156, "topic": "Monitoring", "question": "Что такое Alertmanager?", "options": ['Управляет уведомлениями в Prometheus', 'Система мониторинга', 'База данных', 'Веб-сервер'], "correct": "Управляет уведомлениями в Prometheus"},
    {"id": 157, "topic": "Monitoring", "question": "Что такое healthcheck?", "options": ['Проверка доступности сервиса', 'Система мониторинга', 'База данных', 'CI/CD система'], "correct": "Проверка доступности сервиса"},
    {"id": 158, "topic": "Monitoring", "question": "Что такое трейсинг (tracing)?", "options": ['Отслеживание запросов в распределённых системах', 'Система мониторинга', 'База данных', 'CI/CD система'], "correct": "Отслеживание запросов в распределённых системах"},
    {"id": 159, "topic": "Monitoring", "question": "Что такое 'metrics' в мониторинге?", "options": ['Числовые показатели состояния системы', 'Логи', 'Трейсы', 'События'], "correct": "Числовые показатели состояния системы"},
    {"id": 160, "topic": "Monitoring", "question": "Что такое 'dashboard'?", "options": ['Панель визуализации метрик', 'База данных', 'Система алертов', 'Сетевой протокол'], "correct": "Панель визуализации метрик"},
    {"id": 161, "topic": "Monitoring", "question": "Как часто cron проверяет вебхук в Container Packer?", "options": ['Каждую минуту', 'Каждые 5 минут', 'Каждые 15 минут', 'Каждый час'], "correct": "Каждые 5 минут"},
    {"id": 162, "topic": "Monitoring", "question": "Сколько времени занимает восстановление вебхука в Container Packer?", "options": ['1-2 секунды', '5-6 секунд', '10-11 секунд', 'Минута'], "correct": "5-6 секунд"},
    {"id": 163, "topic": "Monitoring", "question": "Сколько времени занимает восстановление приложения (Streamlit) в Container Packer?", "options": ['1-2 секунды', '5-6 секунд', '10-11 секунд', 'Минута'], "correct": "10-11 секунд"},
    ...
    {"id": 165, "topic": "My Cases", "question": "Как вы починили 502 Bad Gateway на Container Packer?", "options": ['Перезапустил Nginx', 'Ограничил CPU через CPUQuota=80% в systemd', 'Добавил больше памяти', 'Обновил Python'], "correct": "Ограничил CPU через CPUQuota=80% в systemd"},
    {"id": 166, "topic": "My Cases", "question": "Почему перестал работать Webhook и как вы исправили?", "options": ['GitHub изменил API', 'Порт 9000 заблокировал хостинг, перевел на HTTPS через Nginx', 'Слетели права доступа', 'Закончилось место'], "correct": "Порт 9000 заблокировал хостинг, перевел на HTTPS через Nginx"},
    {"id": 167, "topic": "My Cases", "question": "Какой уникальный опыт вы получили на линии 102?", "options": ['Работа с критически важной системой 24/7', 'Настройка маршрутизаторов', 'Программирование на C++', 'Администрирование Windows'], "correct": "Работа с критически важной системой 24/7"},
    {"id": 168, "topic": "My Cases", "question": "Какой стек использует Container Packer?", "options": ['Django + MySQL', 'Streamlit + Nginx + systemd', 'Node.js + MongoDB', 'PHP + Apache'], "correct": "Streamlit + Nginx + systemd"},
    {"id": 169, "topic": "My Cases", "question": "Как вы настроили мониторинг для Container Packer?", "options": ['Prometheus + Grafana', 'Beszel + Telegram-алерты', 'Zabbix', 'Nagios'], "correct": "Beszel + Telegram-алерты"},
    {"id": 170, "topic": "My Cases", "question": "Что вы внедрили в CRM Planfix?", "options": ['Учет ИТ-оборудования и ITSM-процессы', 'Чат-бот', 'Онлайн-магазин', 'Биллинг'], "correct": "Учет ИТ-оборудования и ITSM-процессы"},
    {"id": 171, "topic": "My Cases", "question": "Какой CI/CD вы используете в Container Packer?", "options": ['Jenkins', 'GitLab CI', 'GitHub Actions + Webhook', 'TeamCity'], "correct": "GitHub Actions + Webhook"},
    {"id": 172, "topic": "My Cases", "question": "Какой VPS провайдер заблокировал порт 9000?", "options": ['hoster.by', 'kamatera.com', 'fornex.com', 'digitalocean.com'], "correct": "fornex.com"},
    {"id": 173, "topic": "My Cases", "question": "Какой домен использует Container Packer?", "options": ['autolot25.ddns.net', 'packer.cuby.by', 'trainer.ddns.net', 'aigenerator.myvnc.com'], "correct": "packer.cuby.by"},
    {"id": 174, "topic": "My Cases", "question": "Как часто настроен ределивер в GitHub Actions?", "options": ['Каждый час', 'Каждые 6 часов', 'Раз в день', 'Раз в неделю'], "correct": "Каждые 6 часов"},
    {"id": 175, "topic": "My Cases", "question": "Какая итоговая надёжность системы Container Packer?", "options": ['90-95%', '95-97%', '97-99%', '99.9%'], "correct": "97-99%"},
    {"id": 176, "topic": "My Cases", "question": "Что вы использовали для асинхронного ответа вебхука?", "options": ['celery', 'threading', 'asyncio', 'multiprocessing'], "correct": "threading"},
    {"id": 177, "topic": "My Cases", "question": "Какой язык использует Auto Inventory System?", "options": ['Python (Flask)', 'Python (Django)', 'Node.js', 'Go'], "correct": "Python (Flask)"},
    {"id": 178, "topic": "My Cases", "question": "Какой домен у AI Post Generator?", "options": ['aigenerator.ddns.net', 'aigenerator.myvnc.com', 'ai.cuby.by', 'generator.ai'], "correct": "aigenerator.myvnc.com"},
    {"id": 179, "topic": "My Cases", "question": "Что вы используете для мониторинга серверов?", "options": ['Prometheus', 'Zabbix', 'Beszel', 'Datadog'], "correct": "Beszel"},
    {"id": 180, "topic": "My Cases", "question": "Какой домен у DevOps Interview Trainer?", "options": ['trainer.ddns.net', 'trainer.myvnc.com', 'devops.cuby.by', 'interview.ai'], "correct": "trainer.ddns.net"},
    {"id": 181, "topic": "My Cases", "question": "Сколько вопросов в DevOps Interview Trainer?", "options": ['50', '100', '150', '278'], "correct": "278"},
    {"id": 182, "topic": "My Cases", "question": "Какой стек использует DevOps Interview Trainer?", "options": ['Flask + Nginx', 'Django + Apache', 'Node.js + Express', 'Go + Nginx'], "correct": "Flask + Nginx"},
    {"id": 183, "topic": "My Cases", "question": "Что вы использовали для управления версиями Container Packer?", "options": ['Git', 'SVN', 'Mercurial', 'Perforce'], "correct": "Git"},
    {"id": 184, "topic": "My Cases", "question": "Какой сервер использует Container Packer?", "options": ['VPS на Fornex', 'AWS', 'Google Cloud', 'Azure'], "correct": "VPS на Fornex"},
    {"id": 185, "topic": "My Cases", "question": "Какой сервис используете для Telegram уведомлений?", "options": ['Telegram Bot API', 'Webhook', 'Long Polling', 'Все варианты'], "correct": "Telegram Bot API"},
    {"id": 186, "topic": "My Cases", "question": "Что используете для асинхронного вебхука?", "options": ['threading', 'asyncio', 'celery', 'multiprocessing'], "correct": "threading"},
    {"id": 187, "topic": "My Cases", "question": "Какая команда перезапускает сервис container-packer?", "options": ['sudo systemctl restart container-packer', 'sudo service restart', 'sudo restart', 'sudo reload'], "correct": "sudo systemctl restart container-packer"},
    {"id": 188, "topic": "My Cases", "question": "Что делает скрипт deploy.sh в Container Packer?", "options": ['git pull + systemctl restart', 'docker build', 'npm install', 'python setup.py'], "correct": "git pull + systemctl restart"},
    {"id": 189, "topic": "My Cases", "question": "Как часто запускается ределивер в GitHub Actions для Container Packer?", "options": ['Каждый час', 'Каждые 6 часов', 'Раз в день', 'Раз в неделю'], "correct": "Каждые 6 часов"},
    {"id": 190, "topic": "My Cases", "question": "На каком языке написан скрипт ределивера в Container Packer?", "options": ['Python', 'Bash', 'JavaScript (Node.js, Octokit)', 'Go'], "correct": "JavaScript (Node.js, Octokit)"},
    {"id": 191, "topic": "My Cases", "question": "Какой статус код считается неудачным для вебхука в ределивере?", "options": ['200-299', '300-399', 'Меньше 200 или больше 299', 'Только 500'], "correct": "Меньше 200 или больше 299"},
    {"id": 192, "topic": "My Cases", "question": "Какой флаг в ределивере проверяет, что доставка ещё не переотправлялась?", "options": ['redelivered', 'retry', 'redelivery', 'attempt'], "correct": "redelivery"},
    {"id": 193, "topic": "My Cases", "question": "При каком заполнении диска приходит Telegram-уведомление в Container Packer?", "options": ['Более 50%', 'Более 75%', 'Более 85%', 'Более 95%'], "correct": "Более 85%"},
    {"id": 194, "topic": "My Cases", "question": "Как называется Telegram-бот для уведомлений в Container Packer?", "options": ['ContainerBot', 'PackerBot', 'AutoInventoryBot', 'DeployBot'], "correct": "AutoInventoryBot"},
    {"id": 195, "topic": "My Cases", "question": "Какой порт слушает вебхук в Container Packer?", "options": ['80', '443', '8080', '9000'], "correct": "9000"},
    {"id": 196, "topic": "My Cases", "question": "Какой порт слушает Streamlit-приложение в Container Packer?", "options": ['80', '443', '8501', '9000'], "correct": "8501"},
    {"id": 197, "topic": "My Cases", "question": "Какой домен у DevOps Interview Trainer?", "options": ['trainer.ddns.net', 'trainer.myvnc.com', 'devops.cuby.by', 'interview.ai'], "correct": "trainer.ddns.net"},
    {"id": 198, "topic": "My Cases", "question": "Какой фреймворк используется в DevOps Interview Trainer?", "options": ['Django', 'Flask', 'FastAPI', 'Express'], "correct": "Flask"},
    {"id": 199, "topic": "My Cases", "question": "Какой скрипт отвечает за деплой в Container Packer?", "options": ['deploy.sh', 'webhook.py', 'start.sh', 'update.sh'], "correct": "deploy.sh"},
    {"id": 200, "topic": "My Cases", "question": "Какая команда перезапускает вебхук при сбое?", "options": ['sudo systemctl restart webhook', 'sudo restart webhook', 'sudo webhook restart', 'sudo service webhook restart'], "correct": "sudo systemctl restart webhook"},
    {"id": 201, "topic": "My Cases", "question": "Какой сервис обрабатывает асинхронные запросы от GitHub?", "options": ['Flask', 'Streamlit', 'Webhook на Python', 'Nginx'], "correct": "Webhook на Python"},
    {"id": 202, "topic": "My Cases", "question": "Что делает параметр MemoryMax в systemd?", "options": ['Ограничивает память сервиса', 'Увеличивает память', 'Задаёт swap', 'Ничего не делает'], "correct": "Ограничивает память сервиса"},
    {"id": 203, "topic": "My Cases", "question": "Какой алгоритм используется для упаковки коробок?", "options": ['3D bin packing', '2D bin packing', 'Genetic algorithm', 'Greedy algorithm'], "correct": "3D bin packing"},
    {"id": 204, "topic": "My Cases", "question": "Какой порт использует Nginx для HTTPS?", "options": ['80', '443', '8080', '8443'], "correct": "443"},
    {"id": 205, "topic": "Networks", "question": "Чем отличается TCP от UDP?", "options": ['TCP быстрее, UDP надёжнее', 'TCP надежный с подтверждением, UDP быстрый без подтверждения', 'TCP для веб-сайтов, UDP для файлов', 'Одинаковые'], "correct": "TCP надежный с подтверждением, UDP быстрый без подтверждения"},
    {"id": 206, "topic": "Networks", "question": "Что такое reverse proxy?", "options": ['Сервер для кеширования', 'Сервер, перенаправляющий запросы на внутренние сервера', 'Балансировщик нагрузки', 'Файрвол'], "correct": "Сервер, перенаправляющий запросы на внутренние сервера"},
    {"id": 207, "topic": "Networks", "question": "Какой порт у HTTPS?", "options": ['80', '443', '22', '8080'], "correct": "443"},
    {"id": 208, "topic": "Networks", "question": "Что такое DNS?", "options": ['Превращает домен в IP-адрес', 'Система шифрования', 'База данных', 'Язык программирования'], "correct": "Превращает домен в IP-адрес"},
    {"id": 209, "topic": "Networks", "question": "Что происходит при вводе https://site.com?", "options": ['DNS → TCP → TLS → HTTP', 'HTTP → DNS → TCP', 'TLS → TCP → DNS', 'TCP → HTTP → DNS'], "correct": "DNS → TCP → TLS → HTTP"},
    {"id": 210, "topic": "Networks", "question": "Чем отличается HTTP от HTTPS?", "options": ['HTTPS использует порт 80', 'HTTPS шифрует данные (TLS/SSL)', 'HTTP быстрее', 'Это одно и то же'], "correct": "HTTPS шифрует данные (TLS/SSL)"},
    {"id": 211, "topic": "Networks", "question": "Что такое 502 Bad Gateway?", "options": ['Сервер не найден', 'Шлюз не получил ответ от бэкенда', 'Нет доступа', 'Слишком много запросов'], "correct": "Шлюз не получил ответ от бэкенда"},
    {"id": 212, "topic": "Networks", "question": "Какой порт у SSH?", "options": ['22', '23', '21', '25'], "correct": "22"},
    {"id": 213, "topic": "Networks", "question": "Что такое VLAN?", "options": ['Виртуальная локальная сеть', 'Тип маршрутизатора', 'Протокол шифрования', 'Система мониторинга'], "correct": "Виртуальная локальная сеть"},
    {"id": 214, "topic": "Networks", "question": "Что такое NAT?", "options": ['Преобразование сетевых адресов', 'Протокол туннелирования', 'Система обнаружения вторжений', 'Тип файрвола'], "correct": "Преобразование сетевых адресов"},
    {"id": 215, "topic": "Networks", "question": "Как проверить, открыт ли порт на сервере?", "options": ['telnet host port', 'nc -zv host port', 'nmap host -p port', 'Все варианты'], "correct": "Все варианты"},
    {"id": 216, "topic": "Networks", "question": "Что такое CIDR?", "options": ['Формат записи IP-сетей', 'Протокол маршрутизации', 'Тип DNS записи', 'Система шифрования'], "correct": "Формат записи IP-сетей"},
    {"id": 217, "topic": "Networks", "question": "Какой протокол используется для ping?", "options": ['TCP', 'UDP', 'ICMP', 'ARP'], "correct": "ICMP"},
    {"id": 218, "topic": "Networks", "question": "Что такое SSL/TLS?", "options": ['Протокол шифрования', 'Система аутентификации', 'Сетевой протокол', 'База данных'], "correct": "Протокол шифрования"},
    {"id": 219, "topic": "Networks", "question": "Что такое HTTP/2?", "options": ['Новая версия HTTP с мультиплексированием', 'Система кеширования', 'Протокол шифрования', 'Тип сервера'], "correct": "Новая версия HTTP с мультиплексированием"},
    {"id": 220, "topic": "Networks", "question": "Что такое 'subnet' (подсеть)?", "options": ['Логическое разделение IP-сети', 'Тип маршрутизатора', 'Сетевой протокол', 'Система шифрования'], "correct": "Логическое разделение IP-сети"},
    {"id": 221, "topic": "Networks", "question": "Что такое 'TLS handshake'?", "options": ['Обмен ключами для шифрования', 'Тип соединения', 'Сетевой протокол', 'Аутентификация'], "correct": "Обмен ключами для шифрования"},
    {"id": 222, "topic": "Scripting", "question": "Какая библиотека Python используется для создания веб-приложений в Auto Inventory System?", "options": ['Django', 'Flask', 'FastAPI', 'Tornado'], "correct": "Flask"},
    {"id": 223, "topic": "Scripting", "question": "Какой фреймворк Python используется в AI Post Generator для веб-интерфейса?", "options": ['Flask', 'Django', 'Streamlit', 'FastAPI'], "correct": "Streamlit"},
    {"id": 224, "topic": "Scripting", "question": "Как в Python создать асинхронный ответ вебхука, чтобы не блокировать GitHub?", "options": ['asyncio', 'threading', 'multiprocessing', 'celery'], "correct": "threading"},
    {"id": 225, "topic": "Scripting", "question": "Какая библиотека используется для работы с Telegram Bot API в Container Packer?", "options": ['requests', 'python-telegram-bot', 'telebot', 'Все варианты'], "correct": "Все варианты"},
    {"id": 226, "topic": "Scripting", "question": "Как в Python отправить HTTP-запрос к API?", "options": ['requests.get()', 'urllib.request', 'http.client', 'Все варианты'], "correct": "Все варианты"},
    {"id": 227, "topic": "Scripting", "question": "Какая библиотека используется в ределивере для работы с GitHub API?", "options": ['axios', 'requests', 'Octokit', 'fetch'], "correct": "Octokit"},
    {"id": 228, "topic": "Scripting", "question": "Как в JavaScript (Node.js) установить пакет через npm?", "options": ['npm install <package>', 'npm add <package>', 'npm get <package>', 'npm download <package>'], "correct": "npm install <package>"},
    {"id": 229, "topic": "Scripting", "question": "Какой инструмент используется для запуска JavaScript-скрипта в ределивере?", "options": ['node script.js', 'npm run script', 'js script.js', 'javascript script.js'], "correct": "node script.js"},
    {"id": 230, "topic": "Scripting", "question": "Какая библиотека Python используется для мониторинга и проверки здоровья вебхука?", "options": ['requests', 'urllib', 'http.client', 'Все варианты'], "correct": "Все варианты"},
    {"id": 231, "topic": "Scripting", "question": "Как в Python получить переменные окружения?", "options": ["os.environ.get('KEY')", "os.getenv('KEY')", 'Оба варианта', 'Ни один'], "correct": "Оба варианта"},
    {"id": 232, "topic": "Scripting", "question": "Как в Node.js получить переменные окружения?", "options": ['process.env.KEY', 'system.env.KEY', "os.getenv('KEY')", 'environment.KEY'], "correct": "process.env.KEY"},
    {"id": 233, "topic": "Scripting", "question": "Как в Python отправить сообщение в Telegram через Bot API?", "options": ['requests.post(url, json=data)', 'telegram.send()', 'bot.send_message()', 'api.call()'], "correct": "requests.post(url, json=data)"},
    {"id": 234, "topic": "Scripting", "question": "Какая структура данных в Python используется для хранения вопросов в тренажёре?", "options": ['Список словарей (list of dicts)', 'Массив', 'JSON', 'XML'], "correct": "Список словарей (list of dicts)"},
    {"id": 235, "topic": "Scripting", "question": "Как в Python запустить shell-команду и получить вывод?", "options": ['subprocess.run()', 'os.system()', 'os.popen()', 'Все варианты'], "correct": "Все варианты"},
    {"id": 236, "topic": "Scripting", "question": "Как в Python создать простой HTTP-сервер для вебхука?", "options": ['http.server', 'flask', 'fastapi', 'Все варианты'], "correct": "Все варианты"},
    {"id": 237, "topic": "Scripting", "question": "Как в Node.js выполнить HTTP-запрос к API?", "options": ['axios.get()', 'fetch()', 'http.request()', 'Все варианты'], "correct": "Все варианты"},
    {"id": 238, "topic": "Scripting", "question": "Какой менеджер пакетов используется в проекте ределивера?", "options": ['npm', 'yarn', 'pnpm', 'Все варианты'], "correct": "npm"},
    {"id": 239, "topic": "Scripting", "question": "Как в Python обработать ошибку при HTTP-запросе?", "options": ['try/except', 'if response.status_code != 200', 'Оба варианта', 'Ни один'], "correct": "Оба варианта"},
    {"id": 240, "topic": "Scripting", "question": "Как в JavaScript распарсить JSON-ответ от API?", "options": ['JSON.parse()', 'response.json()', 'Оба варианта', 'Ни один'], "correct": "Оба варианта"},
    {"id": 241, "topic": "Scripting", "question": "Какой фреймворк Python используется в DevOps Interview Trainer?", "options": ['Django', 'Flask', 'FastAPI', 'Streamlit'], "correct": "Flask"},
    {"id": 242, "topic": "Security", "question": "Что такое Fail2ban?", "options": ['Блокирует IP после неудачных попыток входа', 'Файрвол', 'Система мониторинга', 'Антивирус'], "correct": "Блокирует IP после неудачных попыток входа"},
    {"id": 243, "topic": "Security", "question": "Как запретить вход по паролю в SSH?", "options": ['PasswordAuthentication no', 'PermitRootLogin no', 'AllowUsers no', 'DisablePassword yes'], "correct": "PasswordAuthentication no"},
    {"id": 244, "topic": "Security", "question": "Что такое SSL/TLS?", "options": ['Протокол шифрования', 'Система мониторинга', 'База данных', 'CI/CD система'], "correct": "Протокол шифрования"},
    {"id": 245, "topic": "Security", "question": "Что такое Let's Encrypt?", "options": ['Бесплатный центр сертификации SSL', 'Антивирус', 'Файрвол', 'CI/CD система'], "correct": "Бесплатный центр сертификации SSL"},
    {"id": 246, "topic": "Security", "question": "Что такое DDoS атака?", "options": ['Перегрузка сервера запросами', 'Кража данных', 'Вирус', 'Атака на пароль'], "correct": "Перегрузка сервера запросами"},
    {"id": 247, "topic": "Security", "question": "Как защитить SSH?", "options": ['Использовать ключи, запретить пароль, сменить порт', 'Никак', 'Поставить антивирус', 'Выключить сеть'], "correct": "Использовать ключи, запретить пароль, сменить порт"},
    {"id": 248, "topic": "Security", "question": "Что такое OWASP?", "options": ['Стандарт безопасности веб-приложений', 'Антивирус', 'База данных', 'CI/CD система'], "correct": "Стандарт безопасности веб-приложений"},
    {"id": 249, "topic": "Security", "question": "Что такое 'HTTPS'?", "options": ['HTTP с шифрованием', 'Сетевой протокол', 'База данных', 'Система мониторинга'], "correct": "HTTP с шифрованием"},
    {"id": 250, "topic": "Security", "question": "Что такое 'API key'?", "options": ['Ключ для аутентификации API', 'Пароль', 'Сертификат', 'Токен'], "correct": "Ключ для аутентификации API"},
    {"id": 251, "topic": "Security", "question": "Какой порт закрыт от внешнего мира в Container Packer?", "options": ['443', '80', '8501', '9000'], "correct": "8501"},
    {"id": 252, "topic": "Systemd", "question": "Что делает параметр StartLimitIntervalSec в systemd?", "options": ['Задаёт интервал для подсчёта перезапусков', 'Задаёт таймаут запуска', 'Ограничивает CPU', 'Ограничивает память'], "correct": "Задаёт интервал для подсчёта перезапусков"},
    {"id": 253, "topic": "Systemd", "question": "Что делает параметр StartLimitBurst в systemd?", "options": ['Максимальное число перезапусков за интервал', 'Скорость запуска', 'Приоритет процесса', 'Лимит памяти'], "correct": "Максимальное число перезапусков за интервал"},
    {"id": 254, "topic": "Terraform", "question": "Что такое Terraform?", "options": ['Инструмент IaC (Infrastructure as Code)', 'CI/CD система', 'База данных', 'Веб-сервер'], "correct": "Инструмент IaC (Infrastructure as Code)"},
    {"id": 255, "topic": "Terraform", "question": "Что такое 'terraform plan'?", "options": ['Показывает изменения до применения', 'Применяет изменения', 'Удаляет инфраструктуру', 'Создает план работ'], "correct": "Показывает изменения до применения"},
    {"id": 256, "topic": "Terraform", "question": "Что такое состояние (state) в Terraform?", "options": ['Файл с информацией о ресурсах', 'Система мониторинга', 'База данных', 'Логи'], "correct": "Файл с информацией о ресурсах"},
    {"id": 257, "topic": "Terraform", "question": "Чем отличается Terraform от Ansible?", "options": ['Terraform для управления инфраструктурой, Ansible для конфигурации', 'Они одинаковые', 'Terraform для конфигурации, Ansible для инфраструктуры', 'Ни чем'], "correct": "Terraform для управления инфраструктурой, Ansible для конфигурации"},
    {"id": 258, "topic": "Terraform", "question": "Что такое провайдер в Terraform?", "options": ['Плагин для взаимодействия с API (AWS, GCP, Azure)', 'Тип ресурса', 'Система мониторинга', 'База данных'], "correct": "Плагин для взаимодействия с API (AWS, GCP, Azure)"},
    {"id": 259, "topic": "Terraform", "question": "Как импортировать существующий ресурс?", "options": ['terraform import <address> <id>', 'terraform add', 'terraform create', 'terraform load'], "correct": "terraform import <address> <id>"},
    {"id": 260, "topic": "Terraform", "question": "Что делает 'terraform destroy'?", "options": ['Уничтожает всю инфраструктуру', 'Сохраняет состояние', 'Применяет изменения', 'Показывает план'], "correct": "Уничтожает всю инфраструктуру"}
]
, "correct": "CPUQuota=80%"},
...
"""
    ...
    ("Databases", "Databases"),
    ("Docker", "Docker"),
    ("Drone CI + Codeberg (Forgejo)", "Drone CI + Codeberg (Forgejo)"),
